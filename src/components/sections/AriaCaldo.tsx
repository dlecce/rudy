    ...
    return (
        <section id="aria-caldo">
            ...
            <ul>
                ...
                <li>Rudy può salire sul <ImagePopup imageUrl="/img/rudy-davanzale.jpg">davanzale con i vasi</ImagePopup>, tutto ok.</li>
                ...
                <ul>
                    ...
                    <li>Il telecomando di quello in camera da letto è sulla <ImagePopup imageUrl="/img/telecomando.jpg">testiera del letto</ImagePopup>.</li>
